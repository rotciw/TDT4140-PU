    ...
    >
      ...
      <v-list>
        ...
        <v-list-tile>
          ...
          <v-list-tile-content>
            <v-list-tile-title v-text="'Maria'" />
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-action>
          ...
          <v-list-tile-content>
            <v-list-tile-title v-text="'Mathilde'" />
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-action>
        ...
        <v-list-tile>
          ...
          <v-list-tile-content>
            <v-list-tile-title v-text="'Wictor'" />
          </v-list-tile-content>
        </v-list-tile>
      </v-list>
    </v-navigation-drawer>
